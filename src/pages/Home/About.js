        ...
        <div>
            ...
            <div className="hero px-12">
                <div className="hero-content flex-col lg:flex-row">
                    <img src="https://i.ibb.co/8MJtdVc/about.webp" className="lg:max-w-md rounded-lg" />
                    <div className='max-w-lg lg:pl-12'>
                        <h1 className="text-3xl text-accent text-left font-bold">Save more with GO! We give you the lowest prices on all your grocery needs.</h1>
                        <h5 className='mt-8 text-xl font-semibold'>Our Vision</h5>
                        <p className="py-3 text-gray-500"><small>Our vision is to create a better everyday life for many people. That's aspirational, short and to the point. More than that, it sets the tone for the company and makes it clear that they're in the market to offer low-priced organic grocery that suit everyone's health.</small></p>
                        <h5 className='text-xl font-semibold'>Our Goal</h5>
                        <p className="py-3 text-gray-500"><small>I recently set both personal and company goals for 2022 and I’m determined to hit every one of them.  I was very much inspired by watching the OKR video from Google (Warning: its 1h 29m long with the last 20 being QA), if 1 hour is too much of a commitment here is another rather extensive resource from re: Work that speaks to OKR (Objective and Key Results – Goals) setting and grading.</small></p>
                    </div>
                </div>
            </div>
