...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-center p-10 bg-primary text-white rounded">
            <div className='flex items-center justify-center pl-5 normal-case font-serif italic text-2xl'>
                <img className='h-12 w-12' src={fav} alt="" />
                <p>Organic Grocer</p>
            </div>
            <div>
            ...
            <div>
                <p>Copyright &copy; {year} - All right reserved by Organic Grocer.</p>
            </div>
        </footer>
    );
};
